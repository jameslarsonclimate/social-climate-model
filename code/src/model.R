...
model=function(time=1:81,
  ...
  for(t in 2:length(time)){
    ...
    if(is.null(temperature_anomaly)) weather[t]=temperature[t,1]+naturalvariability[t]
    if(!is.null(temperature_anomaly)) weather[t]=temperature[t,1]+naturalvariability[t]+temperature_anomaly[t]

...
homophily_param1 = 0.7  # Set the degree of similarity in social networks
...
pbc_opinionchange1 = c(0, 0, -0.5)  # Effect of opinion change due to policy change
...
ggsave("../results/figure2a.png",plot=a)
...
source("src/model.R")  
homophily_param1 = 0.75  # Higher similarity in social networks
...
ggsave("../results/figure2b.png",plot=a)
...
source("src/model.R")  
frac_opp_01 = 0.26  # Doubtful and dismissive individuals
frac_neut_01 = 0.33  # Cautious and disengaged individuals
policyopinionfeedback_01 = 0  # No feedback between policy and opinion
homophily_param = 0.95  # Very high similarity in social networks
...
reps = 1  # Number of model repetitions for randomization (set to 1 for now)
...
ggsave("../results/figure2c.png",plot=a)

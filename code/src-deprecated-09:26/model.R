...
model=function(time=1:81,
               ...
               weights_multiplier=weights_multiplier1,
  ...
  if(is.null(natvar)) naturalvariability=Re(randomts(gtemp))[1:length(time)]*natvar_multiplier # *8
  ...
  for(t in 2:length(time)){
    ...
    temp5=anomalyfunc(weather,t,biassedassimilation,shiftingbaselines,weights_multiplier)
    anomaly[t]=temp5[[1]]
    print(length(temp5[[2]]))
    print(length(anomaly[t]))

...
# This multiplies the natural variability of the earth system. The author set this to 8.
natvar_multiplier1=8

# This changes how much people weight previous years of weather
weights_multiplier1=1